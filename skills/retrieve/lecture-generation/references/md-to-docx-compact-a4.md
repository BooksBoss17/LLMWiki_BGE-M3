...
> Local copy for lecture-generation. Source reference also exists under `retrieve/llmwiki-rag-retrieval/references/`; keep synchronized when the Word compact A4 workflow changes.
